...
<tr><td style="padding-left:20px;padding-bottom:10px;"><select id="selectTyls" onChange="selectTpl(this)">
  ...
  <tr>
    <td height="30" style="padding-left:20px;"><div id="showpicdiv" class="showpicdiv" style="width:10px;height:3px;"><A style="border:2px solid #fff;display:block;" HREF="#" onclick="show_MorePic(1)"  id="showPicID"><img border="0" onerror="this.src=replace_img(this.src);" onload="if(this.height>200)this.height='200';" id="upfile_PicUrl"></A></div><div id="MSG_say"></div></td>
  </tr>
</table>
...
function replace_img(url){
	...
	re   = /$myurl/g;
	link_s = url.replace(re, "http://down2.or58.com");
	return link_s;
}
</SCRIPT>
EOT;
