...
<div class="wrap J_check_wrap">	
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=windid&c=client'; ?>">客户端列表</a></li>
		</ul>
	</div>
	...
	<div class="cc mb10"><a class="btn J_dialog" title="添加客户端" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=windid&c=client&a=add'; ?>" role="button"><span class="add"></span>添加客户端</a></div>
		...
		<table width="100%">
			...
			<tbody id="J_client_tbody">
				...
				<tr>
					...
					<td>
						<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?id=', rawurlencode($v['id']),'&m=windid&c=client&a=edit'; ?>" class="mr10 J_dialog" title="编辑客户端">[编辑]</a>
						<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?id=', rawurlencode($v['id']),'&m=windid&c=client&a=delete'; ?>" class="mr10 J_ajax_del" data-msg="确定要删除选中内容?">[删除]</a>
					</td>
				</tr>
				<?php  endforeach; ?>
			</tbody>
...
<script>
var CLIENT_URL = "<?php echo Wekit::app()->baseUrl,'/','admin.php?m=windid&c=client&a=clientTest'; ?>";
