...
<div class="wrap">
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum'; ?>">版块管理</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=unite'; ?>">版块合并</a></li>
			<!-- <li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=baseinfo'; ?>">基本信息</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=extinfo'; ?>">功能设置</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=classif'; ?>">主题分类</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=permissions'; ?>">权限相关</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=credits'; ?>">积分相关</a></li> -->
		</ul>
	</div>
	<div class="h_a">搜索</div>
	<div class="table_full">
		<form id="J_forum_search_form" method="post" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=searchforum'; ?>">
			<table width="100%">
				<tr>
					<td>
						<div class="fl">
	...
	<form class="J_ajaxForm" data-role="list" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=dorun'; ?>" method="post">
	<div class="mb10">
  ...
  $cateClass = $forumList[$cate['fid']] ? ' away_icon' : ' zero_icon';?>
			...
			<tr id="J_forum_tr_<?php echo htmlspecialchars($cate['fid'], ENT_QUOTES, 'UTF-8');?>">
				...
				<td><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=cate&fid=', rawurlencode($cate['fid']); ?>" target="_blank" class="mr5">[访问]</a><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?fid=', rawurlencode($cate['fid']),'&m=bbs&c=setforum&a=edit'; ?>" class="mr5">[编辑]</a><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?fid=', rawurlencode($cate['fid']),'&m=bbs&c=setforum&a=deleteforum'; ?>" class="mr5 J_ajax_del">[删除]</a></td>
			</tr>
			</tbody>
			...
			<tr id="J_forum_tr_<?php echo htmlspecialchars($forum['fid'], ENT_QUOTES, 'UTF-8');?>">
				...
				<td><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=thread&fid=', rawurlencode($forum['fid']); ?>" target="_blank" class="mr5">[访问]</a><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?fid=', rawurlencode($forum['fid']),'&m=bbs&c=setforum&a=edit'; ?>" class="mr5">[编辑]</a><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?fid=', rawurlencode($forum['fid']),'&m=bbs&c=setforum&a=deleteforum'; ?>" class="mr5 J_ajax_del">[删除]</a></td>
			</tr>
					<?php  } ?>
			</tbody>
				<?php  } 
...
$(function(){
	...
	$('#J_table_list').on('blur', '.J_forum_names_input', function() {
		...
		//判断版块名是否修改过
		if($this.val() !== org_val) {
			$.post("<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=editname'; ?>", {fid: $this.data('id'), name: $this.val() }, function(data){
...
*/
	...
	function search_suggestion(search_data) {
		...
		if(search_text.length >= 2) {
			...
			$.post('<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=searchforum'; ?>', {'keyword':search_data}, function(data) {
			
				if(data.state === 'success') {
					var push_html = [];
					$.each(data.data, function(i, o){
						push_html.push('<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=setforum&a=edit'; ?>&fid='+ o.fid +'">'+ o.name +'</a></li>');
