...
<div class="wrap J_check_wrap">
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=u&c=check'; ?>">注册审核</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=u&c=check&a=email'; ?>">邮件审核</a></li>
		</ul>
	</div>
	<div class="h_a">提示信息</div>
	<div class="mb10 prompt_text">
		<ul>
			<li>如果<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=regist'; ?>">【注册设置】</a>中开启了“新用户注册审核”，则需要在这里审核通过后，用户才能正常操作</li>
		</ul>
	</div>
	<form action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=u&c=check&a=docheck'; ?>" method="post" class="J_ajaxForm">
		...
		<div class="btn_wrap">
		 <div class="btn_wrap_pd">
			<div class="select_pages">
				<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?perpage=20&m=u&c=check'; ?>">20</a><span>|</span>
				<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?perpage=50&m=u&c=check'; ?>">50</a><span>|</span>
				<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?perpage=100&m=u&c=check'; ?>">100</a>
			</div>
			<label class="mr20"><input type="checkbox" name="checkAll" value="" class="J_check_all" data-direction="x" data-checklist="J_check_user_x">全选</label><button class="btn btn_submit J_ajax_submit_btn" type="submit">通过</button><button data-action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=u&c=check&a=delete'; ?>" type="submit" class="btn mr10 J_ajax_submit_btn">忽略</button><span id="J_user_tip" style="display:none;" class="tips_error"></span>
		 </div>
		</div>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?perpage=', rawurlencode($perpage),'&page=', rawurlencode($_page_i),'&m=u&c=check'; 
