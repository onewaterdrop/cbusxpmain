...
<div class="wrap">
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=backup&c=backup'; ?>">数据库备份</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=backup&c=backup&a=restore'; ?>">数据库还原</a></li>
		</ul>
	</div>
	<div class="h_a">数据表</div>
	<form action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=backup&c=backup&a=doback'; ?>" method="post" class="J_ajaxForm" id="J_backup_form">
	...
	<div class="btn_wrap">
		...
		<button class="btn J_ajax_submit_btn" type="submit" data-action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=backup&c=backup&a=repair'; ?>">修复</button>
		<button class="btn J_ajax_submit_btn" type="submit" data-action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=backup&c=backup&a=optimize'; ?>">优化</button>
		<div id="J_backup_tip"></div>
		</div>
	</div>
