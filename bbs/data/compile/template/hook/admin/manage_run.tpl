...
<div class="wrap">
	...
	<div class="prompt_text">
		<form id="J_forum_search_form" method="post" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=hook&c=manage&a=search'; ?>">
	...
	<div class="cc mb10"><!-- <a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=hook&c=manage&a=add'; ?>" class ="btn J_dialog mr10" title="添加新钩子"><span class="add"></span>添加新钩子</a> -->
	<a class="btn J_ajax_refresh" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=bbs&c=cache&a=doHook'; ?>">更新hook緩存</a>
	</div>
		...
		<table width="100%" id="J_table_list" style="table-layout:fixed;">
			...
			<tr>
				<td>
					...
					<!-- <a class="J_dialog link_add" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?hook_name=', rawurlencode($v['name']),'&m=hook&c=inject&a=add'; ?>" style="display: none;" title="添加injector">添加</a> -->
				</td>
				...
				<td>
				<!-- <a class="J_dialog mr5" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?name=', rawurlencode($v['name']),'&m=hook&c=manage&a=edit'; ?>" title="编辑hook">[编辑]</a>
				<a class="J_ajax_del mr5" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?name=', rawurlencode($v['name']),'&m=hook&c=manage&a=del'; ?>">[删除]</a> -->
				<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?name=', rawurlencode($v['name']),'&m=hook&c=manage&a=detail'; ?>" class="mr5">[查看详细]</a></td>
			</tr>
			<?php  } ?>
			</tbody>
		</table>
...
?>
	...
	<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?name=', rawurlencode($name),'&page=', rawurlencode($page_i),'&m=hook&c=manage&a=search'; ?>" class="pages_pre">&laquo;&nbsp;上一页</a>

<?php  } if(count($hooks) == $perpage) {
$page_i = $page + 1;
 ?>
 
	<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?name=', rawurlencode($name),'&page=', rawurlencode($page_i),'&m=hook&c=manage&a=search'; ?>" class="pages_next">下一页&nbsp;&raquo;</a>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?page=', rawurlencode($_page_i),'&m=hook&c=manage'; 
