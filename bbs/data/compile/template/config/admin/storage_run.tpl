...
<div class="nav">
	<ul class="cc">
		...
		<li  class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=storage'; ?>">头像存储</a></li>
	</ul>
</div>
...
<div class="prompt_text">
	<ul>
		...
		<!-- <li>头像存储支持app扩展，可以到<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=appcenter&c=app'; ?>">应用中心</a>下载更多的可用存储方案。</li> -->
		...
		<li>如果<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=windid&c=windid'; ?>">WindID设置</a>为“作为客户端”，将采用WindID服务端设置。</li>
	</ul>
</div>

<form method="post" class="J_ajaxForm" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=storage&a=dostroage'; ?>" data-role="list">
	...
	<div class="table_full">
		<table width="100%">
			...
			<tr>
				<th>远程头像地址</th>
				<td><input type="text" class="input length_5" name="avatarurl" value="<?php echo htmlspecialchars($config['avatarurl'], ENT_QUOTES, 'UTF-8');?>"></td>
