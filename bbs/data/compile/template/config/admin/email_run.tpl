...
<div class="wrap">
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=email'; ?>">电子邮件设置</a></li>
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=email&a=send'; ?>">电子邮件检测</a></li>
		</ul>
	</div>
	...
	<form class="J_ajaxForm" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=config&c=email&a=dorun'; ?>" method="post">
