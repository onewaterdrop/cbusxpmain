...
<div class="wrap">
	...
	<div class="nav">
		<ul class="cc">
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=log&c=manage'; ?>">前台日志</a></li>
			<li class=""><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=log&c=adminlog'; ?>">后台日志</a></li>
			<li class=""><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=log&c=loginlog'; ?>">用户登录日志</a></li>
		</ul>
	</div>
	...
	<div class="search_type cc mb10">
		<form action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=log&c=manage'; ?>" method="post">
		<div class="ul_wrap">
			<ul class="cc">
				<li>
	...
	?>
			<tr>
				...
				<td><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($_item['created_userid']); ?>" target="_blank"><?php echo htmlspecialchars($_item['created_username'], ENT_QUOTES, 'UTF-8');?></a></td>
				<td><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($_item['operated_uid']); ?>" target="_blank"><?php echo htmlspecialchars($_item['operated_username'], ENT_QUOTES, 'UTF-8');?></a></td>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?page=', rawurlencode($_page_i),'&m=log&c=manage'; 
...
<?php } ?>
	...
	<div class="btn_wrap">
		<div class="btn_wrap_pd">
			<a class="btn" id="J_clear" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=log&c=manage&a=clear'; ?>">确定清除3个月前日志</a>
		</div>
	</div>
	<?php }?>
