...
<div class="nav">
	<ul class="cc">
		<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?c=auth'; ?>">后台用户</a></li>
		<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?c=role'; ?>">管理角色</a></li>
	</ul>
</div>
...
<div class="cc mb10"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?c=auth&a=add'; ?>" title="添加用户" class="btn J_dialog"><span class="add"></span>添加后台用户</a></div>
...
<?php foreach($list as $var): ?>
		<tr>
			...
			<td>
				<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?id=', rawurlencode($var['id']),'&c=auth&a=edit'; ?>" title="编辑用户" class="mr10 J_dialog">[编辑]</a>
				<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?id=', rawurlencode($var['id']),'&c=auth&a=del'; ?>" class="mr10 J_ajax_del">[删除]</a>
			</td>
		</tr>
<?php endforeach; ?>
	</table>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?page=', rawurlencode($_page_i),'&c=auth'; 
