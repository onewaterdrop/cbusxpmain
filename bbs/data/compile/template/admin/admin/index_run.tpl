		...
		<div class="wrap">
			...
			<table width="100%" height="100%" style="table-layout:fixed;">
				...
				<tr class="tab">
					<th>
					<div class="search">
						<input size="15" placeholder="Hi，phpwind 9！" id="J_search_keyword" type="text">
...
?>
<script src="<?php echo htmlspecialchars($openPlatformUrl, ENT_QUOTES, 'UTF-8');?>sitepush.php?a=notice&siteurl=<?php echo htmlspecialchars($siteurl, ENT_QUOTES, 'UTF-8');?>&version=<?php echo htmlspecialchars($version, ENT_QUOTES, 'UTF-8');?>&uid=<?php echo htmlspecialchars($uid, ENT_QUOTES, 'UTF-8');?>&ts=<?php echo htmlspecialchars($ts, ENT_QUOTES, 'UTF-8');?>&sign=<?php echo htmlspecialchars($sign, ENT_QUOTES, 'UTF-8');?>" charset="UTF-8"></script>
<?php  } ?>
	</body>
</html>
