...
<div class="wrap">
	...
	<form class="J_ajaxForm" action="<?php echo Wekit::app()->baseUrl,'/','admin.php?c=custom&a=doRun'; ?>" method="post">
...
<script>
var ROLE_AUTH_CONFIG = <?php echo WindJson::encode($myMenu, 'UTF-8');?>; //当前角色的已有权限集合
