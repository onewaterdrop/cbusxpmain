...
<link href="<?php echo Wekit::app()->themes.'/space/default/css'.Wekit::getGlobal('theme','debug'); ?>/style.css?v=<?php echo htmlspecialchars(NEXT_RELEASE, ENT_QUOTES, 'UTF-8');?>" rel="stylesheet" />
<style>
.aPre{
	cursor:url(<?php echo Wekit::app()->themes.'/site/'.Wekit::C('site', 'theme.site.default').'/images'; ?>/common/pre.cur),auto;
}
.aNext{
	cursor:url(<?php echo Wekit::app()->themes.'/site/'.Wekit::C('site', 'theme.site.default').'/images'; ?>/common/next.cur),auto;right:0;
}
</style>
</head>
...
?>
	...
	<audio autoplay="autoplay">
		<source src="<?php echo Wekit::app()->themes.'/space/default/images'; ?>/message/msg.wav" type="audio/wav" />
		<source src="<?php echo Wekit::app()->themes.'/space/default/images'; ?>/message/msg.mp3" type="audio/mp3" />
		<div style='overflow:hidden;width:0;float:left'><embed src='<?php echo Wekit::app()->themes.'/space/default/images'; ?>/message/msg.wav' width='0' height='0' AutoStart='true' type='application/x-mplayer2'></embed></div>
	</audio>
	<?php  } 
  } ?>
	</div>
...
<div class="space_page">
	...
	<div class="space_nav">
		<ul>
			<li class="<?php echo htmlspecialchars(Pw::isCurrent($src == 'index'), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($space->spaceUid); ?>">新鲜事</a></li>
			<li class="<?php echo htmlspecialchars(Pw::isCurrent($src == 'thread'), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=thread&uid=', rawurlencode($space->spaceUid); ?>">帖子</a></li>
			<?php
PwHook::display(array(PwSimpleHook::getInstance("space_nav"), "runDo"), array($space, $src), "", $__viewer);
?>
			<li class="<?php echo htmlspecialchars(Pw::isCurrent($src == 'profile'), ENT_QUOTES, 'UTF-8');?>"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=profile&uid=', rawurlencode($space->spaceUid); ?>">资料</a></li>
		</ul>
	</div>
	<?php  if ($space->tome == 2): ?>
	...
	<?php  if ($space->tome == 2): ?>
		<a id="J_space_set" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=myspace'; ?>" class="design_space_edit">模块管理</a>
	<?php  endif; ?>
		...
		<div class="space_content" id="J_feed_lists">
			<?php  
				...
				if (!$fresh) {
					if ($space->tome == 2) {
			?>
				<div class="box"><div class="not_content">啊哦，新鲜事暂没有内容哦！去<a href="<?php echo Wekit::app()->baseUrl; ?>">首页看看</a>大家都在说什么！</div></div>
			 		<?php  } else { ?>
			...
			<div class="box">
				<div class="space_fresh">
					<dl class="cc">
						...
						<dd>
							<?php  if ($value['title']) { ?>
							<div class="title"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($value['created_userid']); ?>" class="author J_user_card_show" data-uid="<?php echo htmlspecialchars($value['created_userid'], ENT_QUOTES, 'UTF-8');?>" target="_blank"><?php echo htmlspecialchars($value['created_username'], ENT_QUOTES, 'UTF-8');?></a>：
							<a href="<?php echo Wekit::app()->baseUrl,'/','read.php?tid=', rawurlencode($value['src_id']); ?>" class="subject" target="_blank"><?php echo htmlspecialchars($value['title'], ENT_QUOTES, 'UTF-8');?></a>
							</div>
							<div id="J_feed_content_<?php echo htmlspecialchars($value['id'], ENT_QUOTES, 'UTF-8');?>" class="descrip"><?php echo $value['content'];?></div>
							<?php  } else { ?>
							<div class="title"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($value['created_userid']); ?>" class="author J_user_card_show" data-uid="<?php echo htmlspecialchars($value['created_userid'], ENT_QUOTES, 'UTF-8');?>" target="_blank"><?php echo htmlspecialchars($value['created_username'], ENT_QUOTES, 'UTF-8');?></a>：
 ...
 if ($_picCount > 4) {?><li>共<?php echo htmlspecialchars($_picCount, ENT_QUOTES, 'UTF-8');?>张图片</li><?php }?>
									<!-- 
									<li style="background:url(<?php echo Wekit::app()->themes.'/space/default/images'; ?>/preview.jpg) center center no-repeat;width:160px;"></li>
									<li style="background:url(<?php echo Wekit::app()->themes.'/space/default/images'; ?>/preview.jpg) center center no-repeat;width:185px;"></li> -->
									<!-- <li>共20张图，1个附件</li> -->
								</ul>
							</div>
							<?php  } 
  if ($value['quote']) { ?>
								<div class="feed_repeat feed_quote">
									...
									<div class="title"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($value['quote']['created_userid']); ?>" class="name" target="_blank"><?php echo htmlspecialchars($value['quote']['created_username'], ENT_QUOTES, 'UTF-8');?></a>：
									<a href="<?php echo Wekit::app()->baseUrl,'/','read.php?tid=', rawurlencode($value['quote']['tid']); ?>" class="subject" target="_blank"><?php echo htmlspecialchars($value['quote']['subject'], ENT_QUOTES, 'UTF-8');?></a>
									</div>
  ...
  if ($value['is_read_all']) { ?>
							<div class="more"><a class="J_read_all_none" data-dir="down" data-id="J_feed_content_<?php echo htmlspecialchars($value['id'], ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wekit::app()->baseUrl,'/','read.php?tid=', rawurlencode($value['src_id']); ?>">阅读全部&darr;</a></div>
							<?php  } ?>
						</dd>
					</dl>
					<p class="my_info">
						<?php  if($loginUser->uid) { ?>
						<span class="right"><a rel="nofollow" data-id="<?php echo htmlspecialchars($value['id'], ENT_QUOTES, 'UTF-8');?>" class="J_feed_toggle" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&a=reply&id=', rawurlencode($value['id']),'&uid=', rawurlencode($space->spaceUid); ?>">回复<span style="<?php echo htmlspecialchars($style_reply, ENT_QUOTES, 'UTF-8');?>">(<em id="J_feed_count_<?php echo htmlspecialchars($value['id'], ENT_QUOTES, 'UTF-8');?>"><?php echo htmlspecialchars($value['replies'], ENT_QUOTES, 'UTF-8');?></em>)</span></a></span>
						<?php  } ?>
						<span class="time"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&a=fresh&uid=', rawurlencode($value['created_userid']),'&id=', rawurlencode($value['id']); ?>"><?php echo htmlspecialchars(Pw::time2str($value['created_time'], 'auto'), ENT_QUOTES, 'UTF-8');?></a></span>&nbsp;来自<?php echo $value['from'];?>
					</p>
				</div>
			</div>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&uid=', rawurlencode($space->spaceUid),'&page=', rawurlencode($_page_i); 
		...
		<div class="space_sidebar">
				...
				<div class="space_user_info">
					...
					<div class="operate cc">
						<?php  if($space->tome == 4): ?>
						<a class="follow unfollow J_space_follow J_qlogin_trigger" data-uid="<?php echo htmlspecialchars($space->spaceUid, ENT_QUOTES, 'UTF-8');?>" data-role="unfollow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=delete&uid=', rawurlencode($space->spaceUid); ?>" >取消关注</a>
						<?php  else: ?>
						<a rel="nofollow" class="J_space_follow follow J_qlogin_trigger" data-uid="<?php echo htmlspecialchars($space->spaceUid, ENT_QUOTES, 'UTF-8');?>" data-role="follow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=add&uid=', rawurlencode($space->spaceUid); ?>"><em></em>加关注</a>
						<?php  endif; ?>		
						<a rel="nofollow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=message&c=message&a=pop&uid=', rawurlencode($space->spaceUser['uid']); ?>" class="message J_qlogin_trigger J_send_msg_pop" data-name="<?php echo htmlspecialchars($space->spaceUser['username'], ENT_QUOTES, 'UTF-8');?>"><em></em>写私信</a>
						<?php
...
?>
					...
					<div class="num">
						<ul>
							<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=follows&uid=', rawurlencode($space->spaceUid); ?>"><span><?php echo htmlspecialchars($space->spaceUser['follows'], ENT_QUOTES, 'UTF-8');?></span><em>关注</em></a></li>
							<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=fans&uid=', rawurlencode($space->spaceUid); ?>"><span><?php echo htmlspecialchars($space->spaceUser['fans'], ENT_QUOTES, 'UTF-8');?></span><em>粉丝</em></a></li>
							<li class="tail"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=thread&uid=', rawurlencode($space->spaceUid); ?>"><span><?php echo htmlspecialchars($space->spaceUser['postnum'], ENT_QUOTES, 'UTF-8');?></span><em>帖子</em></a></li>
						</ul>
					</div>
					...
					<div class="medal">
						<ul class="cc">
							...
							?>
								<li><a rel="nofollow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=medal'; ?>"><img src="<?php echo htmlspecialchars($medal['icon'], ENT_QUOTES, 'UTF-8');?>" title="<?php echo htmlspecialchars($medal['name'], ENT_QUOTES, 'UTF-8');?>" width="30" height="30" alt="<?php echo htmlspecialchars($medal['name'], ENT_QUOTES, 'UTF-8');?>"/></a>
								</li>
							<?php  endforeach; ?>	
						</ul>
					</div>
					...
					if ($punchOpen && ($space->tome == 2 || ($space->tome == 3 && $punchFriendOpen))) {
					 ...
					 ?>
						...
						<?php  if ($punchData) { ?>
						<div style="display:none;"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&username=', rawurlencode($punchData['username']); ?>"><?php echo htmlspecialchars($punchData['username'], ENT_QUOTES, 'UTF-8');?></a> 已帮<?php echo htmlspecialchars($spaceTome, ENT_QUOTES, 'UTF-8');?>领取<?php echo htmlspecialchars($punchData['cNum'], ENT_QUOTES, 'UTF-8');
...
<script>
	var SPACE_FOLLOW = "<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=add'; ?>",
		SPACE_UNFOLLOW = "<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=follow&a=delete'; ?>";
</script>
...
?>
			<div class="box">
				<div class="hd">
					<?php  if ($space->tome == 2): ?>
					<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=visitor'; ?>" class="more">全部</a>
					<?php  endif; ?>
...
?>
			<div class="box">
				<div class="hd">
				<?php  if ($space->tome == 2): ?>
					<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=profile&c=tag&_tab=tag'; ?>" class="more">管理</a>
				<?php  endif; ?>
				...
				<div class="ct">
					...
					<?php  foreach($tags AS $key => $value):?>
						<a rel="nofollow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=my&c=friend&a=search&usertag=', rawurlencode($value['name']); ?>"><?php echo htmlspecialchars($value['name'], ENT_QUOTES, 'UTF-8');?></a>
					<?php  endforeach; ?>	
					</div>
				</div>
			</div>
...
?>
			<div class="box">
				<div class="hd">
				<?php  if ($space->tome == 2): ?>
					<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=tag&a=my'; ?>" class="more">全部</a>
				<?php  endif; ?>
				...
				<div class="ct">
					<div class="space_topic_list">
						...
						<?php  foreach($tags AS $value):?>
							<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=tag&a=view&name=', rawurlencode($value['tag_name']); ?>"><?php echo htmlspecialchars($value['tag_name'], ENT_QUOTES, 'UTF-8');?></a><span>(<?php echo htmlspecialchars($value['content_count'], ENT_QUOTES, 'UTF-8');?>)</span></li>
						<?php  endforeach; ?>	
						</ul>
					</div>
				</div>
...
?>
			<div class="box">
				<div class="hd">
					<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=follows&uid=', rawurlencode($space->spaceUid); ?>" class="more">全部</a>
...
?>
			<div class="box">
				<div class="hd">
					<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=fans&uid=', rawurlencode($space->spaceUid); ?>" class="more">全部</a>
...
<script>
//新鲜事回复提交地址
var FRESH_DOREPLY = "<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&c=myspace&a=doreply'; ?>";
