...
?>
	...
	<div class="cc">
		<div class="space_content">
			<div class="box">
				<div class="hd">
					<h2><?php echo htmlspecialchars($host, ENT_QUOTES, 'UTF-8');?>的资料</h2>
				</div>
				<div class="space_profile">
					<h3>
						<?php  if ($space->tome == 2): ?>
						<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=profile&_tab=profile'; ?>" class="edit">编辑</a>
						<?php  endif; ?>
						<strong>基本资料</strong>
					</h3>
					<dl class="cc">
						<dt>UID</dt>
						<dd><?php echo htmlspecialchars($space->spaceUid, ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<dl class="cc">
						<dt>头衔</dt>
						<dd><?php echo htmlspecialchars($groupName, ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<dl class="cc">
						<dt>在线时长</dt>
						<dd><?php echo htmlspecialchars(floor($space->spaceUser['onlinetime']/3600), ENT_QUOTES, 'UTF-8');?>&nbsp;小时</dd>
					</dl>
					<?php  if ($space->allowView('constellation')): ?>
					<dl class="cc">
						<dt>星座</dt>
						<dd><?php echo htmlspecialchars($constellation, ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<?php  endif; 
  if ($space->allowView('local')): ?>
					<dl class="cc">
						<dt>现居住地</dt>
						<dd><?php echo htmlspecialchars($space->spaceUser['location_text'], ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<?php  endif; 
  if ($space->allowView('nation')): ?>
					<dl class="cc">
						<dt>家乡</dt>
						<dd><?php echo htmlspecialchars($space->spaceUser['hometown_text'], ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<?php  endif; ?>	
					<dl class="cc">
						<dt>个人主页</dt>
			...
			<?php  if ($space->allowView('aliwangwang') || $space->allowView('qq') || $space->allowView('msn') || $space->allowView('mobile')): ?>
				<div class="space_profile">
					<h3>
					<?php  if ($space->tome == 2): ?>
						<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=profile&a=contact&_tab=contact'; ?>" class="edit">编辑</a>
					<?php  endif; ?>
						<strong>联系方式</strong>
					</h3>
				
					<?php  if ($space->allowView('aliwangwang')): ?>
					<dl class="cc">
						<dt>阿里旺旺</dt>
						<dd><?php echo htmlspecialchars($space->spaceUser['aliww'], ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<?php  endif; 
  if ($space->allowView('qq')): ?>
					<dl class="cc">
						<dt>QQ</dt>
						<dd><?php echo htmlspecialchars($space->spaceUser['qq'], ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<?php  endif; 
  if ($space->allowView('msn')): ?>
					<dl class="cc">
						<dt>MSN</dt>
						<dd><?php echo htmlspecialchars($space->spaceUser['msn'], ENT_QUOTES, 'UTF-8');?></dd>
					</dl>
					<?php  endif; 
