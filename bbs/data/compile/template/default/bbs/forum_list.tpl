		...
		<div class="main cc">
			<div class="forum_page">
				<div class="bbs_info_box">
					<span>今日：<?php echo htmlspecialchars($todayposts, ENT_QUOTES, 'UTF-8');?></span><i></i><span>昨日：<?php echo htmlspecialchars($bbsinfo['yposts'], ENT_QUOTES, 'UTF-8');?></span><i></i><span>最高日：<?php echo htmlspecialchars($bbsinfo['hposts'], ENT_QUOTES, 'UTF-8');?></span><i></i><span>帖子：<?php echo htmlspecialchars($article, ENT_QUOTES, 'UTF-8');?></span><i></i><span>会员：<?php echo htmlspecialchars($bbsinfo['totalmember'], ENT_QUOTES, 'UTF-8');?></span><i></i><span>新会员：<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&username=', rawurlencode($bbsinfo['newmember']); ?>" target="_blank"><?php echo htmlspecialchars($bbsinfo['newmember'], ENT_QUOTES, 'UTF-8');?></a></span>
				</div>
						...
						<div class="box_title">
							<div class="fr">
								...
								<?php foreach ($_cate['manager'] as $_name) {?>
									<a class="J_user_card_show" data-username="<?php echo htmlspecialchars($_name, ENT_QUOTES, 'UTF-8');?>" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=space&username=', rawurlencode($_name); ?>"><?php echo htmlspecialchars($_name, ENT_QUOTES, 'UTF-8');?> </a>
								<?php }
 }?>
							</div>
							<h2 class="cname"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=cate&fid=', rawurlencode($_cateId); ?>"><?php echo $_cate['name'];?></a></h2>
						</div>
