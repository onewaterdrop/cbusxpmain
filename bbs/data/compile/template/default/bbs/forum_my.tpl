...
<div class="tac"> </div>
	<div class="main_wrap">
		...
		<div class="bread_crumb" id="bread_crumb">
			<a href="<?php echo Wekit::app()->baseUrl; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=forum&a=my'; ?>">我的版块</a>
		</div>
		<div class="main cc">
			<div class="main_body">
						...
						<nav>
							<div class="content_nav" id="hashpos_ttype">
								<div class="content_filter">
									<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=forum&a=my&order=postdate'; ?>" class="<?php echo htmlspecialchars(Pw::isCurrent($order == 'postdate'), ENT_QUOTES, 'UTF-8');?>">最新发帖</a><span>|</span><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=forum&a=my'; ?>" class="<?php echo htmlspecialchars(Pw::isCurrent($order != 'postdate'), ENT_QUOTES, 'UTF-8');?>">最后回复</a></div>
								<ul>
									<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs'; ?>">本站新帖</a></li>
									<li class="current"><a rel="nofollow" href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=forum&a=my'; ?>">我的版块</a></li>
								</ul>
							</div>
						</nav>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=forum&a=my&page=', rawurlencode($_page_i); 
