...
<div class="tac"> </div>
	<div class="main_wrap">
		<div class="bread_crumb">
			<a href="<?php echo Wekit::app()->baseUrl; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=like'; ?>">喜欢</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=ike&c=mylike&a=ta'; ?>">Ta的喜欢</a>
		</div>
		<div class="main cc">
			<div class="like_nav cc">
				<ul>
					<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=like'; ?>">热门喜欢</a></li>
					<li  class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=mylike&a=ta'; ?>" data-referer="true" class="J_qlogin_trigger">Ta的喜欢</a></li>
					<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=mylike'; ?>" data-referer="true" class="J_qlogin_trigger">我的喜欢</a></li>
				</ul>
			</div>
...
<script>
var J_LIKE_URL = "<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=mylike&a=data'; ?>";
var LIKE_PLUS = "<?php echo Wekit::app()->baseUrl,'/','index.php?m=like&c=mylike&a=doLike&typeid=_FROMTYPE&fromid=_KEY'; ?>";		//点击喜欢地址
var J_LIKE_DATA = "<?php echo WindJson::encode($data, 'UTF-8');?>";
