...
<div class="tac"> </div>
	<div class="main_wrap">
		<div class="bread_crumb">
			<a href="<?php echo Wekit::app()->baseUrl; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my'; ?>">投票</a><em>&gt;</em><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my'; ?>">我的投票</a>
		</div>
		<div class="main cc">
			<div class="main_body">
				<div class="main_content">
					...
					<nav>
						<div class="content_nav">
							<ul>
								<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=hot'; ?>">热门投票</a></li>
								<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=ta'; ?>">Ta的投票</a></li>
								<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my'; ?>">我的投票</a></li>
							</ul>
						</div>
						<div class="content_type">
							<ul class="cc">
								<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my'; ?>">我参与的</a></li>
								<li class="line"></li><li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my&a=create'; ?>">我发起的</a></li>
							</ul>
						</div>
					</nav>
						<div class="vote_list">
...
$threadTip = (!$value['allow_read'] && $value['allow_visit']) ? true : false;
  ...
  if ($forumTip) { ?>
	...
	<?php  } 
							...
							<?php  }} else { ?>
							<div class="not_content">啊哦，你还没有参与过投票哦，赶紧去<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=hot'; ?>">参与</a>！</div>
							<?php  } ?>
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my&page=', rawurlencode($_page_i); 
