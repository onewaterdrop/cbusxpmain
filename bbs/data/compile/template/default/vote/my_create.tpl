...
<div class="tac"> </div>
	<div class="main_wrap">
		<div class="bread_crumb">
			<a href="<?php echo Wekit::app()->baseUrl; ?>" class="home" title="<?php echo Wekit::C("site", "info.name"); ?>">首页</a><em>&gt;</em><a href="">投票</a>
		</div>
		<div class="main cc">
			<div class="main_body">
				<div class="main_content">
					...
					<nav>
						...
						<div class="content_type">
							<ul class="cc">
								<li><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my'; ?>">我参与的</a></li>
								<li class="line"></li><li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my&a=create'; ?>">我发起的</a></li>
							</ul>
						</div>
					</nav>
						<div class="vote_list">
...
<?php  } ?>				
							<div><?php $__tplPageCount=(int)$total;
...
?>
	<a href="<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=my&a=create&page=', rawurlencode($_page_i); 
...
<div id="J_vote_forum_pop" tabindex="0" class="pop_select_forum" style="margin-left:-100px;z-index:11;display:none;">
	...
	<div class="ft">
		<div class="associate">
			<label class="fr"><input type="checkbox" id="J_vote_forum_join" data-url="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=forum&a=join'; ?>">添加到我的版块</label>
			发帖到：<span id="J_vote_post_to_cate"></span>-<span id="J_vote_post_to_forum"></span>
		</div>
		<div class="tac">
			<button type="button" class="btn btn_submit disabled" disabled="disabled" id="J_vote_forum_submit" data-url="<?php echo Wekit::app()->baseUrl,'/','index.php?m=bbs&c=post'; ?>">确定</button>
		</div>
	</div>
</div>
...
<script>
var URL_FORUM_LIST = '<?php echo Wekit::app()->baseUrl,'/','index.php?m=vote&c=vote&a=forumlist'; ?>';
