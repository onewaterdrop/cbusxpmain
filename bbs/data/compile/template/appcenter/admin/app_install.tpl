...
<div class="wrap">
	<div class="nav">
		<ul class="cc">
			<li><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=appcenter&c=app'; ?>">已安装</a></li>
			<li class="current"><a href="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=appcenter&c=app&a=install'; ?>">本地安装</a></li>
...
<?php  if($apps){ ?>
<form action="<?php echo Wekit::app()->baseUrl,'/','admin.php?m=appcenter&c=app&a=toInstall'; ?>" method="post" >
	<div class="table_full mb10">
		<table width="100%">
			<col class="th" />
			<col width="200">
...
<?php foreach ($apps as $k => $v){ ?>
			<tr>
				<th><input type="checkbox" name="apps[]" value="<?php echo htmlspecialchars($v, ENT_QUOTES, 'UTF-8');?>"></th>
				<td><span class="mr10 b"><?php echo htmlspecialchars($v, ENT_QUOTES, 'UTF-8');?></span></td>
				<td><a class="J_ajax_del" href="<?php echo Wekit::app()->baseUrl,'/','admin.php?folder=', rawurlencode($v),'&m=appcenter&c=app&a=delFolder'; ?>">[删除文件]</a></td>
			</tr>
<?php  } ?>
		</table>
	</div>
